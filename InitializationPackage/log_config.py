...
def log_config(app=None):
    ...
    logging.debug("Agent Port is {} (** value ignored by Docker **)".format(app.config["AGENT_PORT"]))
    logging.debug("Agent Debug is {} (** value ignored by Docker **)".format(app.config["AGENT_DEBUG"]))
